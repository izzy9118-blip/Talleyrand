...
def validate_deed_corpus(root: str | Path = ".") -> dict:
    ...
    _require(index.get("version") == "2.9.0", "live deed index must be version 2.9.0")
    _require(index.get("corpus") == "DEED CORPUS 2.9 LIVE-ONLY AFTER C11 RATIFICATION", "live deed corpus label changed")
