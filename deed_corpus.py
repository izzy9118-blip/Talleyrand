...
def validate_deed_corpus(root: str | Path = ".") -> dict:
    ...
    _require(index.get("version") == "2.8.0", "live deed index must be version 2.8.0")
    _require(index.get("corpus") == "DEED CORPUS 2.8 LIVE-ONLY AFTER C8 RATIFICATION", "live deed corpus label changed")
