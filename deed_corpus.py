...
def validate_deed_corpus(root: str | Path = ".") -> dict:
    ...
    _require(index.get("version") == "2.12.0", "live deed index must be version 2.12.0")
    _require(index.get("corpus") == "DEED CORPUS 2.12 ALL LIVE DEEDS OWNER RATIFIED", "live deed corpus label changed")
