...
def test_historical_v3_record_preserves_B7_ratification_and_pre_C2_removal_state():
    record = _record()
...
def test_manifest_continues_to_load_B7_after_C2_removal():
